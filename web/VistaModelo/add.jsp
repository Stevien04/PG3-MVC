...
<div class="form-container">
    ...
    <form action="${pageContext.request.contextPath}/srvModelo" method="post" onsubmit="return validarFormulario();">
        ...
        <input type="text" name="nombre" id="nombre"
               value="${empty modeloFormNombre ? '' : modeloFormNombre}"
               maxlength="20"
               required
        ...
        <select name="estado" id="estado" required>
            <option value="1" ${empty modeloFormEstado || modeloFormEstado == '1' ? 'selected' : ''}>Activo</option>
            <option value="0" ${modeloFormEstado == '0' ? 'selected' : ''}>Inactivo</option>
        </select>
