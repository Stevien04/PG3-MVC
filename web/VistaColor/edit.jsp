    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form action="${pageContext.request.contextPath}/srvColor" method="post" onsubmit="return validarFormulario();">
                ...
                <input type="hidden" name="id" value="${color.idColor}">
                ...
                <select name="estado" id="estado" required>
                    <option value="1" ${color.estado == 1 ? 'selected' : ''}>Activo</option>
                    <option value="0" ${color.estado == 0 ? 'selected' : ''}>Inactivo</option>
                </select>
