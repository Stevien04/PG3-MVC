...
<html>
    <head>
        ...
        <title>Editar Tipo de Talla</title>
        <style>
            body {
    ...
    <body>
        <div class="form-container">
            ...
            <form action="${pageContext.request.contextPath}/srvTipoTalla" method="post" onsubmit="return validarFormulario();">
                ...
                <input type="hidden" name="id" value="${tipoTalla.idTipoTalla}">

                <label for="nombre">Nombre:</label>
                <input type="text" name="nombre" id="nombre"
                       value="${tipoTalla.nombre}"
                       maxlength="50"
                       required
                ...
                <select name="estado" id="estado" required>
                    <option value="1" ${tipoTalla.estado == 1 ? 'selected' : ''}>Activo</option>
                    <option value="0" ${tipoTalla.estado == 0 ? 'selected' : ''}>Inactivo</option>
                </select>
