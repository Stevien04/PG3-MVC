<%-- 
    Document   : add
    Created on : 17 oct. 2025, 9:55:25 a. m.
    Author     : Razse
--%>
    ...
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/srvCategoria" method="post" onsubmit="return validarFormulario();">
            ...
            <input type="text" name="nombre" id="nombre"
                   value="${empty categoriaFormNombre ? '' : categoriaFormNombre}"
                   maxlength="20"
                   required
            ...
            <select name="estado" id="estado" required>
                <option value="1" ${empty categoriaFormEstado || categoriaFormEstado == '1' ? 'selected' : ''}>Activa</option>
                <option value="0" ${categoriaFormEstado == '0' ? 'selected' : ''}>Inactiva</option>
            </select>
